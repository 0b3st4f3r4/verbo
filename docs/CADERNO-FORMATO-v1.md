# CADERNO-FORMATO-v1.md — Formato Binário do Caderno (`.vcad`), v1

**Status:** canônico para a Etapa 4 · **Codec:** [`nucleo/crates/vbl-runtime/src/caderno_producao.rs`](../nucleo/crates/vbl-runtime/src/caderno_producao.rs) · **Verificador:** `vbl caderno-verify ARQUIVO`
...
(âncora [`ChainCaderno::HEAD_INICIAL`](../nucleo/crates/vbl-runtime/src/caderno.rs)).
...
- `extra_json` = objeto JSON com **chaves em ordem de classificação** (`BTreeMap`
  — serializador de [`json.rs`](../nucleo/crates/vbl-runtime/src/json.rs),
...
| Formato binário compacto (AGENTS §1.4) | §2; testes de roundtrip/adulteração/truncagem em `tests/caderno_producao.rs` |
