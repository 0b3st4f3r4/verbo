# STAGE-5-LABORATORY.md — Validação laboratorial (Etapa 5, PLAN §5.1)
...
([STAGE-5-REPORT.md](STAGE-5-REPORT.md) §5–§6): execução longa de 24 h,
...
`logs/stage5/lab/hw-thermal-subversion.vcad` (+ `.jsonl`, cadeia ÍNTEGRA) — o
cenario canônico (`example2_speculative_trading.vl`) com o sensor real:
...
[STAGE-5-REPORT.md](STAGE-5-REPORT.md) §5: a correção estrutural
