...
pub use notebook::{Caderno, ChainCaderno, Evento};
pub use production_notebook::{
    jsonl_de_binario, verificar, verificar_binario, verificar_jsonl, CadernoProducao, RelatorioVerificacao,
    Resumo,
};
pub use engine::Engine;
pub use form::{ActionRt, Form, Manutencao, RuleRt, VALOR_POETICO_CANONICO};
